...
class VTSassessment(object):
    ...
    def receivercalcs(self):
        ...
        if rf is not None and mind < 5:
            ...
            fig,ax = plt.subplots()
            recimg = plt.imread(os.getcwd()+'\\images\\Moving.png')
    ...
    def totalstats(self):
        ...
        byzone = {'Deep Left': {'Targets': 0,
                  ...
                  'Right Flat': {'Targets': 0,
                                ...
                                'Height': 5,
                                'Width': 40/3}}
        for i,fname in enumerate(plist):
            ## read in json file
            # add relative folder path to more complete path
            # (This will need to be changed for each user)
            folder = 'C:\\Users\\tyler.mckee\\Projects\\'
        ...
        fieldimg = plt.imread(os.getcwd()+'\\images\\bwField.png')
