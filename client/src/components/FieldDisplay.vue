...
NumMachine()
  ...
  grid: {
    ...
    yaxis: {
      range: [this.trackingData['qbtrackingdata'][this.sliderTime]['y'] -10,this.trackingData['qbtrackingdata'][this.sliderTime]['y'] + 30],
      showgrid: false,
      showlegend: false,
      hoverlabel: true,
      zeroline: false,
  ...
  // console.log(this.traces, "THIS IS BEFORE PLOT traces")
  // console.log(this.layout, "THIS IS BEFORE PLOT layout")
  // console.log(this.aframes, "THIS IS BEFORE PLOT aframes")
  // Plotly.plot('plotter', {
  //   data: this.traces,
  //   layout: this.layout,
  //   frames: this.aframes,
  ...
  let self = this
  Plotly.plot('plotter', {
    data: this.aframes[this.sliderTime].data,
    layout: this.layout
  }).then(function(){
